        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Mobile Applications</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="card" id="propertyList">
                <div class="container">
                    ...
                    @endif
                    <a href="{{ route('mobile.create') }}" class="btn btn-primary">Add Content to Mobile Apps</a>
                    <table class="table mt-3">
                        ...
                        <tbody>
                            @foreach ($mobileContent as $content)
                                <tr>
                                    <td>{{ $content->id }}</td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <!-- Edit form -->
                                                <form action="{{ route('mobile.update', $content->id) }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="server" class="form-control" id="server_name{{ $content->id }}" value="{{ $content->server_name }}" required>
                                                    </div>
                                ...
                                <div class="modal fade" id="deleteModal{{ $content->id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $content->id }}" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Are you sure you want to delete this Mobile Application?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                                                <form action="{{ route('mobile.destroy', $content->id) }}" method="POST">
                                                    @csrf
